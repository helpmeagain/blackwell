import { GetClinicalConsultationByIdUseCase } from './get-clinical-consultation-by-id-use-case';
...
let sut: GetClinicalConsultationByIdUseCase;

describe('Get Clinical Consultation By Id', () => {
  beforeEach(() => {
    inMemoryConsultationRepository = new InMemoryConsultationRepository();
    sut = new GetClinicalConsultationByIdUseCase(inMemoryConsultationRepository);
  });
