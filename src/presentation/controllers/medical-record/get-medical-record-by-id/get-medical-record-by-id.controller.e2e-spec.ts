...
describe('Get medical record by id [E2E]', () => {
  ...
  test('[GET] /medical-records/:id', async () => {
    ...
    expect(result.body).toEqual({
      medicalRecord: expect.objectContaining({
        id: patient.medicalRecord.id.toString(),
        patientId: patient.medicalRecord.patientId.toString(),
        consultationsIds: [],
        diagnosis: null,
        comorbidity: null,
      }),
