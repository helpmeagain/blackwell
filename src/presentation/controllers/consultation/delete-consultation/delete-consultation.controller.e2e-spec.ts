...
describe('Delete consultation by id [E2E]', () => {
  ...
  test('[DELETE] /consultations/:id', async () => {
    ...
    const result = await request(app.getHttpServer())
      .delete(`/consultations/${consultation.id.toString()}`)
    ...
    expect(consultationOnDatabase).toBeNull();
  });
});
